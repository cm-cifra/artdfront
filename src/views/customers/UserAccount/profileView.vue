<template>
  <div class="flex justify-center items-center p-20 bg-gray-100 min-h-screen">
    <div class="flex mx-10 bg-white p-8 rounded-lg shadow-xl w-full max-w-7xl">
      ...
      <!-- Profile Form Section (conditionally displayed) -->
      <ProfileForm
      ...
      <!-- Purchase Form Section (conditionally displayed) -->
...
export default {
  components: {
    ProfileForm,
    PurchaseForm, // Register the PurchaseForm component
  },
  data() {
    return {
      user: {
      ...
      currentView: "profile", // Default view is 'profile'
    };
  },
  methods: {
    fetchUserData() {
    ...
    // Set the current view based on the clicked item
    setView(view) {
